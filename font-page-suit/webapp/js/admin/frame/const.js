...
var DIALOG_DRIVER_CHOOSER=BASE_ROUTE_URL+"/dialogs/driverChooser"+BASE_ROUTE_LAST_TOKEN;
var DIALOG_CUSTOMER_CHOOSER=BASE_ROUTE_URL+"/dialogs/customerChooser"+BASE_ROUTE_LAST_TOKEN;

var ROUTE_DRIVER_INFO=BASE_ROUTE_URL+"/pages/driverInfo"+BASE_ROUTE_LAST_TOKEN;
var ROUTE_MACHINE_INFO=BASE_ROUTE_URL+"/pages/machineInfo"+BASE_ROUTE_LAST_TOKEN;
...
var ROUTE_LOG_ERROR_INFO=BASE_ROUTE_URL+"/pages/logErrorInfo"+BASE_ROUTE_LAST_TOKEN;
var ROUTE_LOG_MAINTAIN_INFO=BASE_ROUTE_URL+"/pages/logMaintainInfo"+BASE_ROUTE_LAST_TOKEN;
var ROUTE_LOG_TRANSPORT_INFO=BASE_ROUTE_URL+"/pages/logTransportInfo"+BASE_ROUTE_LAST_TOKEN;
var ROUTE_LOG_WORK_INFO=BASE_ROUTE_URL+"/pages/logWorkInfo"+BASE_ROUTE_LAST_TOKEN;
var ROUTE_COMPACT_INFO=BASE_ROUTE_URL+"/pages/compactInfo"+BASE_ROUTE_LAST_TOKEN;
