...
INSERT INTO `bean_bank_account` VALUES (1,'公共账号','CY','2222','中国工商银行',NULL,'2018-12-04 10:30:26',NULL),(2,'阿萨大','CYY','333333','中国建设银行',NULL,'2018-12-26 10:24:06',NULL),(3,NULL,NULL,NULL,NULL,NULL,'2018-12-26 10:24:33',NULL),(6,'测试账户','陈岩',NULL,NULL,NULL,'2018-12-27 10:00:08',NULL),(7,'个人账号','陈岩','12345678','中国工商银行',NULL,'2018-12-28 10:12:03',NULL);
...
CREATE TABLE `com_resource` (
  ...
  `edit_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='公共资源表';

#
# Data for table "com_resource"
#

INSERT INTO `com_resource` VALUES (1,'个人信息','trunk','',0,NULL,'2018-12-01 10:52:45','0000-00-00 00:00:00'),(2,'陈岩简历','jpg','home.sise',2222,NULL,'2018-12-01 10:54:34','2018-12-30 10:45:43'),(3,'劳动合同','png','324',222,1,'2018-12-01 10:54:54','0000-00-00 00:00:00'),(4,'个人信息','trunk','sda',213,NULL,'2018-12-01 11:45:15','0000-00-00 00:00:00'),(5,'cesa','png','213',3213,4,'2018-12-01 11:45:37','0000-00-00 00:00:00');
