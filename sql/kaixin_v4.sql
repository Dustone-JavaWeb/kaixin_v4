...
CREATE TABLE `bean_support` (
  ...
  `edit_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `support_resource` (`resource_id`),
  KEY `support_bank_account` (`bank_account_id`),
  CONSTRAINT `support_bank_account` FOREIGN KEY (`bank_account_id`) REFERENCES `bean_bank_account` (`Id`),
  CONSTRAINT `support_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
...
CREATE TABLE `bean_machine_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `machine_type_resource` (`resource_id`),
  CONSTRAINT `machine_type_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
...
INSERT INTO `bean_machine_type` VALUES (1,NULL,'ASD01','小型挖掘机',NULL,'大马力',NULL,NULL),(2,NULL,'AAC','大型挖掘机',NULL,'为全球',NULL,NULL),(3,NULL,'BUZZK','测试挖掘机','','qwerwqerwqerwe rcqwecgwegewrewrecqw',NULL,NULL),(4,NULL,'BUZZK','测试挖掘机','','qwerqwgeryuj',NULL,NULL),(5,NULL,'ADSFSADF','测试挖掘机','','ewgeytjtirmenrt',NULL,NULL),(6,NULL,'SDFAD','测试挖掘机','','wegwgwt',NULL,NULL),(7,NULL,'REHTY','测试挖掘机','','',NULL,NULL),(8,NULL,'WEQRQWR','测试挖掘机','','',NULL,NULL),(9,NULL,'JTYJU','测试挖掘机','','',NULL,NULL);
...
CREATE TABLE `bean_machine` (
  ...
  `tid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '机器型号ID',
  ...
  KEY `machine_resource` (`resource_id`),
  CONSTRAINT `machine_machine_type` FOREIGN KEY (`tid`) REFERENCES `bean_machine_type` (`id`),
  CONSTRAINT `machine_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
...
CREATE TABLE `bean_driver` (
  ...
  PRIMARY KEY (`id`),
  KEY `driver_bank_account` (`bank_account_id`),
  KEY `driver_resource` (`resource_id`),
  CONSTRAINT `driver_bank_account` FOREIGN KEY (`bank_account_id`) REFERENCES `bean_bank_account` (`Id`),
  CONSTRAINT `driver_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='机手信息表';

#
# Data for table "bean_driver"
#

INSERT INTO `bean_driver` VALUES (1,'测试数据1','123123123','21321312','312312321','空闲','普通',NULL,14,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:55:49','2018-12-30 16:07:09',NULL),(2,'测试数据12','123123123','21321312','312312321','空闲','普通',6,16,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','2018-12-30 20:38:04',NULL),(3,'测试数据1213','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(4,'测试数据1213','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(5,'测试数据133425','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(6,'测试数据321','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(7,'测试数234532据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(8,'测试数2543据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(9,'测试23523数据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(10,'测试43424523数据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(11,'测试数3452据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(12,'测试2452数据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(13,'测52435试数据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(14,'测试2534数据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','0000-00-00 00:00:00',NULL),(15,'测5435试数据1','123123123','21321312','312312321','空闲','普通',NULL,11,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:57:50','2018-12-30 16:03:00',NULL),(16,'测试数据12','123123123','21321312','312312321','空闲','普通',NULL,12,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','2018-12-30 16:05:01',NULL),(17,'测试数据1213','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','0000-00-00 00:00:00',NULL),(18,'测试数据1213','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','0000-00-00 00:00:00',NULL),(19,'测试数据133425','123123123','21321312','312312321','离职','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','0000-00-00 00:00:00',NULL),(20,'测试数据321','123123123','21321312','312312321','空闲','普通',NULL,10,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','2018-12-30 16:00:23',NULL),(21,'测试数234532据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','0000-00-00 00:00:00',NULL),(22,'测试数2543据1','123123123','21321312','312312321','空闲','普通',NULL,13,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','2018-12-30 16:05:42',NULL),(23,'测试23523数据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','0000-00-00 00:00:00',NULL),(24,'测试43424523数据1','123123123','21321312','312312321','空闲','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','0000-00-00 00:00:00',NULL),(25,'测试数3452据1','123123123','21321312','312312321','空闲','普通',27,8,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','2018-12-30 15:36:46',NULL),(26,'测试2452数据1','123123123','21321312','312312321','空闲','普通',26,9,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','2018-12-30 15:42:11',NULL),(27,'李延喜','123123123','21321312','312312321','工作','普通',28,19,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','2018-11-25 10:35:33',NULL),(28,'陈岩测试','123123123','21321312','312312321','休假','普通',NULL,NULL,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 22:58:06','2018-11-25 09:54:17',NULL),(29,'陈三十','123123123','213213122121','312312321','工作','临时',18,6,'resource/headPicture/机手_29_陈三十jpg?t=0.8865694685057715','2018-11-14 22:58:06','2018-11-25 10:32:40',NULL),(30,'陈岩','130480','21321312','66666666','工作','普通',NULL,1,'resource/staticPicResource/defaultHeadPic.jpg','2018-11-14 23:04:26','0000-00-00 00:00:00',NULL),(31,'陈岩是个大帅哥','213123123','9999999999','312313123','休假','临时',NULL,1,'resource/headPicture/机手_31_陈岩是个大帅哥jpg?t=0.05914047188548688','2018-11-25 13:16:03','2018-11-25 13:16:03',NULL),(32,'韩红','12345678','12345678','12345678','空闲','普通',15,7,'resource/headPicture/机手_32_韩红jpg?t=0.06896128266428869','2018-12-28 10:12:03','2018-12-28 10:12:03',NULL),(33,'陈岩','13048062053','674462865','77787777','空闲','普通',21,15,'resource/headPicture/机手_33_陈岩JPG?t=0.2994021205555175','2018-12-30 16:27:07','2018-12-30 16:27:07',NULL),(34,'胡汉三','99999999999','292929292929','12312313123','空闲','普通',NULL,23,NULL,'2019-02-03 15:51:49','2019-02-03 15:51:49',NULL);
...
CREATE TABLE `bean_customer` (
  ...
  PRIMARY KEY (`id`),
  KEY `customer_bank_account` (`bank_account_id`),
  KEY `customer_resource` (`resource_id`),
  CONSTRAINT `customer_bank_account` FOREIGN KEY (`bank_account_id`) REFERENCES `bean_bank_account` (`Id`),
  CONSTRAINT `customer_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
...
INSERT INTO `bean_customer` VALUES (1,'广州铠信挖掘机租赁有限公司','普通','正常','测试数据',NULL,2,'2018-12-27 09:21:08','0000-00-00 00:00:00',NULL,NULL,NULL),(2,'中铁十三局','普通','正常','',10,1,'2018-12-27 09:22:06','2018-12-30 21:31:28',NULL,NULL,NULL),(34,'Dustone科技有限公司','普通','正常','特殊用户 源自广州',8,18,'2018-12-27 16:27:10','2018-12-27 16:27:10',NULL,NULL,NULL);
...
CREATE TABLE `bean_contact` (
  ...
  PRIMARY KEY (`Id`),
  KEY `contact_bank_account` (`bank_account_id`),
  KEY `contact_resource` (`resource_id`),
  CONSTRAINT `contact_bank_account` FOREIGN KEY (`bank_account_id`) REFERENCES `bean_bank_account` (`Id`),
  CONSTRAINT `contact_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
...
CREATE TABLE `com_customer_contact` (
  ...
  PRIMARY KEY (`Id`),
  KEY `c_customer_contact` (`contact_id`),
  KEY `c_contact_customer` (`customer_id`),
  CONSTRAINT `c_contact_customer` FOREIGN KEY (`customer_id`) REFERENCES `bean_customer` (`id`),
  CONSTRAINT `c_customer_contact` FOREIGN KEY (`contact_id`) REFERENCES `bean_contact` (`Id`)
...
CREATE TABLE `com_work_compact` (
  `id` int(11) NOT NULL,
  `compact_id` int(11) DEFAULT NULL,
...
CREATE TABLE `log_error` (
  ...
  `driver_id` int(11) unsigned DEFAULT NULL COMMENT '提交机手',
  `support_id` int(11) unsigned DEFAULT NULL COMMENT '后勤ID',
  `machine_id` int(11) unsigned DEFAULT NULL COMMENT '机器ID',
  ...
  `edit_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `error_driver` (`driver_id`),
  KEY `error_support` (`support_id`),
  KEY `error_machine` (`machine_id`),
  KEY `error_resource` (`resource_id`),
  CONSTRAINT `error_driver` FOREIGN KEY (`driver_id`) REFERENCES `bean_driver` (`id`),
  CONSTRAINT `error_machine` FOREIGN KEY (`machine_id`) REFERENCES `bean_machine` (`id`),
  CONSTRAINT `error_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`),
  CONSTRAINT `error_support` FOREIGN KEY (`support_id`) REFERENCES `bean_support` (`id`)
...
CREATE TABLE `log_maintain` (
  ...
  `support_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '后勤人员ID',
  ...
  KEY `maintain_resource` (`resource_id`),
  CONSTRAINT `maintain_machine` FOREIGN KEY (`machine_id`) REFERENCES `bean_machine` (`id`),
  CONSTRAINT `maintain_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`),
...
CREATE TABLE `log_oil` (
  ...
  KEY `oil_resource` (`resource_id`),
  CONSTRAINT `oil_machine` FOREIGN KEY (`machine_id`) REFERENCES `bean_machine` (`id`),
  CONSTRAINT `oil_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`),
...
CREATE TABLE `log_transport` (
  ...
  KEY `transport_resource` (`resource_id`),
  CONSTRAINT `transport_machine` FOREIGN KEY (`machine_id`) REFERENCES `bean_machine` (`id`),
  CONSTRAINT `transport_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`),
  CONSTRAINT `transport_support` FOREIGN KEY (`support_id`) REFERENCES `bean_support` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='转场单';

#
# Data for table "log_transport"
#

INSERT INTO `log_transport` VALUES (1,2,NULL,NULL,1,NULL,NULL,'客户转场',3333.00,NULL,NULL,'未审核',NULL,'2019-01-06 10:26:15','2019-01-06 10:26:15','2019-01-06 07:00:00','2019-01-06 10:26:13'),(2,2,'谢晓航','234234124阿萨大',3,NULL,NULL,'第三方转场',2121.00,NULL,NULL,'已审核',NULL,'2019-01-14 23:45:09','2019-01-14 23:45:09','2019-01-14 23:45:09','2019-01-14 23:45:09'),(3,1,'黄俊强','21121211212撒',1,NULL,NULL,'公司转场',1212.00,NULL,NULL,'已作废',NULL,'2019-01-15 20:55:23','2019-01-15 20:55:23','2019-01-15 20:55:23','2019-01-15 20:55:23'),(4,1,'黄俊强','21121211212撒',4,NULL,NULL,'第三方转场',212.00,NULL,NULL,'未审核','进行中','2019-01-16 09:38:16','2019-01-16 09:38:16','2019-01-16 09:38:16','2019-01-16 09:38:14'),(5,2,'谢晓航','234234124阿萨大',3,NULL,NULL,'第三方转场',23.00,NULL,NULL,'未审核','进行中','2019-02-02 21:23:42','2019-02-02 21:23:42','2019-02-02 21:23:42','2019-02-02 21:23:42');
...
CREATE TABLE `log_work` (
  ...
  CONSTRAINT `work_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='工单';

#
# Data for table "log_work"
#

INSERT INTO `log_work` VALUES (1,1,32,NULL,NULL,1,'合约工单',1212,NULL,NULL,'已审核',NULL,'2019-02-01 11:50:05','2019-01-06 11:50:05','2019-01-06 11:50:05','2019-01-06 11:50:04'),(2,1,33,'陈岩','13048062053',3,'合约工单',123112,NULL,NULL,'已审核',NULL,'2019-02-02 23:46:25','2019-01-14 23:46:25','2019-01-14 23:46:25','2019-01-14 23:46:25'),(3,1,33,'陈岩','13048062053',1,'合约工单',600,NULL,NULL,'已审核','进行中','2019-02-03 22:56:30','2019-01-18 22:56:30','2019-01-18 22:56:30','2019-01-18 22:56:30'),(4,1,33,'陈岩','13048062053',2,'合约工单',2000,NULL,NULL,'已审核','进行中','2019-02-05 19:40:30','2019-02-02 19:40:30','2019-02-02 00:00:00','2019-02-02 19:40:22'),(5,1,33,'陈岩','13048062053',9,'合约工单',32223,NULL,NULL,'已作废',NULL,'2019-02-05 19:41:19','2019-02-02 19:41:19','2019-02-02 00:00:00','2019-02-02 19:41:17'),(6,2,33,'陈岩','13048062053',3,'临时工单',2020,NULL,NULL,'未审核','进行中','2019-03-12 11:35:38','2019-03-12 11:35:38','2019-03-12 11:35:38','2019-03-12 11:35:38');
...
CREATE TABLE `service_compact` (
  ...
  KEY `compact_contact` (`contact_id`),
  KEY `compact_resource` (`resource_id`),
  CONSTRAINT `compact_contact` FOREIGN KEY (`contact_id`) REFERENCES `bean_contact` (`Id`),
  CONSTRAINT `compact_customer` FOREIGN KEY (`customer_id`) REFERENCES `bean_customer` (`id`),
  CONSTRAINT `compact_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
...
INSERT INTO `service_compact` VALUES (1,'201901101',34,NULL,26,'月租合同',1,1,440.00,550.00,110.00,20000.00,40000.00,100000.00,1000.00,50000.00,40000.00,'广州南沙',20,'未审核','2019-01-10 10:22:49',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'2019011401',34,'Dustone科技有限公司',26,'临租合同',0,0,440.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',35,'未审核','2019-01-14 23:49:21',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `com_compact_work` (
  ...
  PRIMARY KEY (`Id`),
  KEY `c_compact_work` (`work_id`),
  KEY `c_work_compact` (`compact_id`),
  CONSTRAINT `c_compact_work` FOREIGN KEY (`work_id`) REFERENCES `log_work` (`id`),
  CONSTRAINT `c_work_compact` FOREIGN KEY (`compact_id`) REFERENCES `service_compact` (`id`)
...
CREATE TABLE `com_compact_transport` (
  ...
  PRIMARY KEY (`Id`),
  KEY `c_compact_transport` (`transport_id`),
  KEY `c_transport_compact` (`compact_id`),
  CONSTRAINT `c_compact_transport` FOREIGN KEY (`transport_id`) REFERENCES `log_transport` (`id`),
  CONSTRAINT `c_transport_compact` FOREIGN KEY (`compact_id`) REFERENCES `service_compact` (`id`)
...
CREATE TABLE `com_compact_machine` (
  ...
  PRIMARY KEY (`Id`),
  KEY `c_machine_compact` (`compact_id`),
  KEY `c_compact_machine` (`machine_id`),
  CONSTRAINT `c_compact_machine` FOREIGN KEY (`machine_id`) REFERENCES `bean_machine` (`id`),
  CONSTRAINT `c_machine_compact` FOREIGN KEY (`compact_id`) REFERENCES `service_compact` (`id`)
...
CREATE TABLE `service_intention` (
  ...
  KEY `intention_resource` (`resource_id`),
  CONSTRAINT `intention_customer` FOREIGN KEY (`customer_id`) REFERENCES `bean_customer` (`id`),
  CONSTRAINT `intention_resource` FOREIGN KEY (`resource_id`) REFERENCES `com_resource` (`id`)
...
CREATE TABLE `service_machine_status` (
  ...
  PRIMARY KEY (`Id`),
  KEY `status_machine` (`machine_id`),
  KEY `status_work` (`compact_id`),
  KEY `status_transport` (`transport_id`),
  KEY `status_maintain` (`maintain_id`),
  KEY `c_status_work` (`work_id`),
  CONSTRAINT `c_status_compact` FOREIGN KEY (`compact_id`) REFERENCES `service_compact` (`id`),
  CONSTRAINT `c_status_work` FOREIGN KEY (`work_id`) REFERENCES `log_work` (`id`),
  CONSTRAINT `status_machine` FOREIGN KEY (`machine_id`) REFERENCES `bean_machine` (`id`),
  CONSTRAINT `status_maintain` FOREIGN KEY (`maintain_id`) REFERENCES `log_maintain` (`id`),
  CONSTRAINT `status_transport` FOREIGN KEY (`transport_id`) REFERENCES `log_transport` (`id`)
...
INSERT INTO `service_machine_status` VALUES (1,1,'工作',NULL,3,NULL,NULL,NULL,NULL,113.280637,23.125178,'2019-01-14 23:58:29'),(2,2,'工作',NULL,4,NULL,NULL,NULL,NULL,113.049752,23.109706,'2019-01-14 23:58:38'),(3,3,'工作',2,6,5,NULL,NULL,NULL,113.036199,24.63638,'2019-01-15 17:14:16'),(4,4,'转场',NULL,NULL,4,NULL,NULL,NULL,113.036111,22.636442,'2019-01-15 21:16:49'),(5,9,'工作',NULL,5,NULL,NULL,NULL,NULL,NULL,NULL,'2019-01-15 21:41:52');
...
INSERT INTO `sys_user` VALUES (1,'admin','123456','','陈岩',b'1',b'0',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2019-03-06 22:34:12');

#
# View "view_driver_status_count"
#
...
CREATE
  ...
  AS
  SELECT
    `service_machine_status`.`Id` AS 'id',
    `service_machine_status`.`machine_id`,
    `service_machine_status`.`status`,
    `bean_machine`.`nameplate` AS 'machine_nameplate',
    `bean_machine`.`code` AS 'machine_code',
    `service_machine_status`.`compact_id`,
    `service_compact`.`type` AS 'compact_type',
    `service_compact`.`number` AS 'compact_number',
    `service_compact`.`customer_id`,
    `service_compact`.`customer_name`,
    `service_machine_status`.`work_id`,
    `log_work`.`driver_id`,
    `log_work`.`driver_name`,
    `log_work`.`driver_tel`,
    `service_machine_status`.`transport_id`,
    `log_transport`.`support_id` AS 'transport_support_id',
    `log_transport`.`support_name` AS 'transport_support_name',
    `log_transport`.`support_tel` AS 'transport_support_tel',
    `service_machine_status`.`maintain_id`,
    `log_maintain`.`support_id` AS 'maintain_support_id',
    `log_maintain`.`support_name` AS 'maintain_support_name',
    `log_maintain`.`support_tel` AS 'maintain_support_tel',
    `service_machine_status`.`wgs_x`,
    `service_machine_status`.`wgs_y`,
    `service_machine_status`.`gcj_x`,
    `service_machine_status`.`gcj_y`,
    `service_machine_status`.`update_time`
  FROM
    (((((`service_machine_status`
      LEFT JOIN `bean_machine` ON ((`service_machine_status`.`machine_id` = `bean_machine`.`id`)))
      LEFT JOIN `service_compact` ON ((`service_machine_status`.`compact_id` = `service_compact`.`id`)))
      LEFT JOIN `log_work` ON ((`service_machine_status`.`work_id` = `log_work`.`id`)))
      LEFT JOIN `log_transport` ON ((`service_machine_status`.`transport_id` = `log_transport`.`id`)))
      LEFT JOIN `log_maintain` ON ((`service_machine_status`.`maintain_id` = `log_maintain`.`id`)));

#
# View "view_machine_status_count"
#
...
CREATE
  ...
  FROM
    `bean_machine`
  WHERE
    ((`status` <> '已出售') AND (`status` <> '已报废'))
  GROUP BY
    `status`;

#
# View "view_work_count"
#
...
CREATE
  ...
  AS
  SELECT
    DATE_FORMAT(`work`.`create_time`, '%d') AS 'time', COUNT(`work`.`id`) AS 'number'
  FROM
    `log_work` work
  WHERE
    (DATE_FORMAT(`work`.`create_time`, '%Y%m') = DATE_FORMAT(CURDATE(), '%Y%m'))
  GROUP BY
    DATE_FORMAT(`work`.`create_time`, '%Y-%m-%d')
  ORDER BY NULL;
...
CREATE TRIGGER compact_customer_trigger BEFORE INSERT
       ON service_compact FOR EACH ROW
BEGIN
     set 
         NEW.customer_name=
...
CREATE TRIGGER machine_status_trigger AFTER INSERT
       ON bean_machine FOR EACH ROW
       insert into service_machine_status (machine_id) values(NEW.id);
...
CREATE TRIGGER status_machine_trigger AFTER UPDATE
       ON service_machine_status FOR EACH ROW
BEGIN
...
CREATE TRIGGER transport_support_trigger BEFORE INSERT
       ON log_transport FOR EACH ROW
BEGIN
     set 
         NEW.support_name=
             (select name from bean_support where bean_support.id=NEW.support_id);
...
CREATE TRIGGER work_driver_trigger BEFORE INSERT
       ON log_work FOR EACH ROW
BEGIN
     set 
         NEW.driver_name=
